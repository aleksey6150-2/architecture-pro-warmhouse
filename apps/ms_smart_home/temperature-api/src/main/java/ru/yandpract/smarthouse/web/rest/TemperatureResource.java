...
public class TemperatureResource {
    ...
    @GetMapping(value = "/temperature/{sensorId}")
    public SensorResponse getTemperatureBySensor(@PathVariable String sensorId) {
        return sensorService.getTemperatureBySensor(sensorId);
    }
